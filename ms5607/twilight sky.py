...
# csv
filename = "/home/pi/python_output/altimeter.csv"
header = "altimeter"
...
while True :
    ...
    difference = alt['a'] - default
    print "Difference : %.2f m"%(difference)
    print " ************************************* "
    time.sleep(0.03)
